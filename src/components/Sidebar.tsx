...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`relative hidden flex-col border-r border-neutral-200 bg-white transition-all duration-300 lg:flex dark:border-neutral-800 dark:bg-neutral-900 ${
    ...
    >
      ...
      <nav className="flex-1 space-y-4 overflow-y-auto px-3 py-2">
        ...
        <div>
          {!isSidebarCollapsed && (
            <span className="block px-3 pb-1 text-[11px] font-bold uppercase tracking-wider text-neutral-400 dark:text-neutral-500">
              Principal
            </span>
          )}
